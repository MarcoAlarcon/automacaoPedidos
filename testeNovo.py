...
def rotina(x):
    ...
    excel = pd.read_excel(f'C:\megatron\pedidos\{x}', sheet_name=2)
    ...
    with sync_playwright() as p:
        ...
        linha = 14 #Mudar para 533 quando for rodar o teste, ou para o tamanho da da planilha de pedidos -2. ex: planilha tem 600 referencias mudar esse campo para 598.
        while linha <=31: #Mudar para 533 quando for rodar o teste, ou para o tamanho da da planilha de pedidos -2. ex: planilha tem 600 referencias mudar esse campo para 598.
            coluna = 7
